...
class SDE(abc.ABC):
    ...
    def discretize(self, x, t, cond):
        ...
        """
        dt = 1 / self.N
        drift, diffusion = self.sde(x, t, cond=cond)
        f = drift * dt
    ...
    def reverse(self, score_fn, probability_flow=False):
        ...
        class RSDE(self.__class__):
            ...
            def sde(self, x, t, cond=None):
                ...
                drift, diffusion = sde_fn(x, t, cond=None) 
            ...
            def discretize(self, x, t, cond=None):
                ...
                f, G = discretize_fn(x, t, cond=None)
                rev_f = f - G[:, None, None] ** 2 * score_fn(x, t, cond) * (0.5 if self.probability_flow else 1.)
